    ...
    <div style={styles.container}>
      <div style={styles.inputWrap}>
        ...
        <input
          ...
          style={{ 
            ...styles.input, 
            ...(focused ? { borderColor: 'var(--green)', boxShadow: '0 0 15px rgba(0, 255, 136, 0.15)' } : {}) 
          }}
        />
      </div>
      <button
...
const styles = {
  ...
  input: { width: '100%', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--border)', borderRadius: 2, color: '#fff', padding: '14px', fontSize: 11, fontFamily: "var(--font-mono)", outline: 'none', transition: '0.3s' },
