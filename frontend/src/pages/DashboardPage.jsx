...
const styles = {
  ...
  eyebrowText: { fontSize: 13, fontWeight: 800, letterSpacing: 2, color: 'var(--green)', opacity: 0.8 },
  title: { fontSize: 32, fontWeight: 800, letterSpacing: 2, marginBottom: 4 },
  sub: { fontSize: 12, color: 'var(--text-secondary)', fontFamily: "var(--font-mono)", letterSpacing: 1, opacity: 0.8 },
  headerRight: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 16 },
  btnGroup: { display: 'flex', gap: 12 },
  primaryBtn: { padding: '10px 20px', background: 'var(--green)', color: '#000', border: 'none', borderRadius: 2, fontWeight: 800, cursor: 'pointer', fontSize: 12, letterSpacing: 1, display: 'flex', alignItems: 'center', gap: 10 },
  secBtn: { padding: '10px 20px', background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)', color: 'var(--text-primary)', borderRadius: 2, fontWeight: 700, cursor: 'pointer', fontSize: 12, letterSpacing: 1, display: 'flex', alignItems: 'center', gap: 10, transition: '0.3s' },
  ...
  sectionTitle: { fontSize: 13, letterSpacing: 2, color: 'var(--text-secondary)', fontWeight: 800, fontFamily: "var(--font-mono)" },
  rcaBtn: { padding: '16px', background: 'rgba(0, 255, 136, 0.05)', border: '1px solid rgba(0, 255, 136, 0.2)', color: 'var(--green)', borderRadius: 2, fontSize: 14, fontWeight: 800, letterSpacing: 2, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, transition: '0.3s' },
  ...
  rcaLabel: { fontSize: 13, fontWeight: 800, color: 'var(--green)', opacity: 0.9, fontFamily: "var(--font-mono)", letterSpacing: 1 },
